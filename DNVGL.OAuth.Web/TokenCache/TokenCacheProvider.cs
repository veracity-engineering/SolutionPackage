...
namespace DNVGL.OAuth.Web.TokenCache
{
	public class TokenCacheProvider : TokenCacheProviderBase
	{
		...
		public TokenCacheProvider(IDistributedCache cache, DistributedCacheEntryOptions cacheOptions, IDataProtectionProvider dataProtectionProvider) : base(cache, cacheOptions)
		{
