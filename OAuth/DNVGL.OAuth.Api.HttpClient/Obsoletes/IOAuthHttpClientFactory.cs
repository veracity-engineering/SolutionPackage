...
namespace DNVGL.OAuth.Api.HttpClient
{
    ...
    {
	    IEnumerable<OAuthHttpClientOptions> ClientOptions { get; }

        /// <summary>
        /// Creates an instance of <see cref="T:System.Net.Http.HttpClient"/> which will make authenticated requests according to
        /// the <see cref="OAuthHttpClientOptions"/> provided where the <see cref="OAuthHttpClientOptions.Name">Name</see> is matched by the argument.
        /// </summary>
        ...
        System.Net.Http.HttpClient Create(Func<OAuthHttpClientOptions, bool> configPredict, Action<OAuthHttpClientOptions>? configOverride = null);

        /// <summary>
        /// Creates an instance of <see cref="T:System.Net.Http.HttpClient"/> which will make authenticated requests according to
        /// the <see cref="OAuthHttpClientOptions"/> provided where the <see cref="OAuthHttpClientOptions.Name">Name</see> is matched by the argument.
        /// </summary>
        /// <param name="apiName">The name of api setting in <see cref="OAuthHttpClientOptions"/></param>
        /// <returns>Instance of <see cref="System.Net.Http.HttpClient"/> which can make authenticated requests.</returns>
        /// <exception cref="Exceptions.ClientConfigurationNotFoundException" />
        /// <exception cref="Exceptions.InvalidCredentialFlowException" />
