    ...
    { 
        ...
        public async Task Test_Disable_All_Features()
        {
            var hostBuilder = new HostBuilder()
                .ConfigureWebHost(webHost =>
                {
                    ...
                    webHost.Configure(app => app.UseDefaultHeaders(h => h.DisableAllPermissionsPolicy())
        ...
        public async Task Test_Enable_All_Features_For_Self()
        {
            var hostBuilder = new HostBuilder()
                ...
                {
                    webHost.UseTestServer();
                    webHost.Configure(app => app.UseDefaultHeaders(h => h.EnableAllPermissionsPolicyForSelf())
                    .Run(async ctx => await ctx.Response.WriteAsync("Hello World!")));
                });
