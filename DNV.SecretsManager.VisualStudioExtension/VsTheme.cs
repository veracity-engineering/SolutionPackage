...
namespace ThemeHelper
{
	public static class VsTheme
	{
		...
		private static ResourceDictionary BuildThemeResources()
		{
			...
			try
			{
				var shellResources = (ResourceDictionary)System.Windows.Application.LoadComponent(new Uri("Microsoft.VisualStudio.Platform.WindowManagement;component/Themes/ThemedDialogDefaultStyles.xaml", UriKind.Relative));
				var scrollStyleContainer = (ResourceDictionary)System.Windows.Application.LoadComponent(new Uri("Microsoft.VisualStudio.Shell.UI.Internal;component/Styles/ScrollBarStyle.xaml", UriKind.Relative));
